  ...
  fluidRow(
    ...
    column(3, wellPanel(
      ...
      tags$div(class='folder-button-list',
        ...
        p('NOTE: DIRECTORY ADDING IS RESTRICTED FOR THE DEMO SERVER. For help adding directories, please view ', 
          a(href='https://github.com/SlavovLab/SCoPE_QC/blob/master/documentation/adding_folders.pdf',
            target='_blank', 'this document')),
        p('Internal users, enter the password to unlock the folder input'),
        numericInput('import_password', 'Unlock Password', 0),
